...
ephoto_single_browser_add(Ephoto *ephoto, Evas_Object *parent)
{
   ...
   elm_menu_item_add(menu, menu_it, "object-rotate-left", _("Rotate Left"), _go_rotate_counterclock, sb);
   elm_menu_item_add(menu, menu_it, "object-rotate-right", _("Rotate Right"), _go_rotate_clock, sb);
   elm_menu_item_add(menu, menu_it, "object-flip-horizontal", _("Flip Horizontal"), _go_flip_horiz, sb);
   elm_menu_item_add(menu, menu_it, "object-flip-vertical", _("Flip Vertical"), _go_flip_vert, sb);
   elm_menu_item_separator_add(menu, NULL);
